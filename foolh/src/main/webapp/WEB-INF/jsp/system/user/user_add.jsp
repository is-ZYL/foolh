					...
					<div class="row">
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									<input type="text" name="USER_ID" id="user_id" value="${pd.USER_ID }"/>
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="CARD" id="CARD"  value="${pd.CARD }" maxlength="32" placeholder="这里输入银行卡号" title="银行卡号"  style="width:98%;"/></td>
										</tr>
										<tr>
										...
										<tr style="display:none">
											<td><input type="text" name="type" id="type"value="${pd.type }" placeholder="这里输入类型" maxlength="64" title="类型" style="width:98%;"/></td>
										</tr>
										<tr>
