...
public abstract class BaseService<T extends BasePojo> {
	 ...
	 * @return
	 */
	public List<T> queryListByWhereASC(T record) {
	 ...
	 * @return
	 */
	public List<T> queryListByWhereInfoDESC(T record, String info) {
		Example example = new Example(record.getClass());
		example.setOrderByClause(info + " DESC");
	 ...
	 * @return
	 */
	public List<T> queryListByWhereExample(Integer page, Integer rows, Example example) {
	 ...
	 * @return
	 */
	public List<T> queryListByWhere(Integer page, Integer rows, T record) {
		PageHelper.startPage(page, rows);
		List<T> list = this.mapper.select(record);
		return list;
	}
