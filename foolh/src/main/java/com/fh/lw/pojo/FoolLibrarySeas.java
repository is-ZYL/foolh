...
public class FoolLibrarySeas extends BasePojo {
	...
	public String toString() {
		return "FoolLibrarySeas [id=" + id + ", foolId=" + foolId + ", seasAddUserId=" + seasAddUserId + ", seasTitle="
				+ seasTitle + ", seasWeigetKg=" + seasWeigetKg + ", seasWeigetCatty=" + seasWeigetCatty + ", seasMsg="
				+ seasMsg + ", seasGiveShopUserId=" + seasGiveShopUserId + ", seasGiveShopUserPhone="
				+ seasGiveShopUserPhone + ", seasSelect=" + seasSelect + ", foolTitle=" + foolTitle + "]";
	}
